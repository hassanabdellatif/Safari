      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              DropdownButton<String>(
                ...
                iconSize: 16,
                hint: Text(
                  AppLocalization.of(context).getTranslated("text_room_type"),
                ),
                ...
                items: <String>[
                  AppLocalization.of(context).getTranslated("text_room_1"),
                  AppLocalization.of(context).getTranslated("text_room_2"),
                  AppLocalization.of(context).getTranslated("text_room_3"),
                  AppLocalization.of(context).getTranslated("text_room_4"),
          ...
          Slider(
            ...
            max: NumberOfPerson(roomType, numberOfPerson).numberOfPersonMax(),
            divisions: 5,
          ...
          Text(
            currentSliderValue.toString() +
                AppLocalization.of(context).getTranslated("text_person"),
            style: TextStyle(fontWeight: FontWeight.w600),
          ),
          SizedBox(
            width: MediaQuery.of(context).size.width,
