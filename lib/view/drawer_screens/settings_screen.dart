...
import 'package:project/models/theme_provider.dart';
...
class _SettingScreenState extends State<SettingScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    lightTheme = (themeNotifier.getTheme() == light);
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              title: Text(
                lightTheme==true?AppLocalization.of(context).getTranslated("text_light_mode"):AppLocalization.of(context).getTranslated("text_dark_mode"),
                style: TextStyle(fontSize: 20, fontWeight: FontWeight.w400),
              ),
  ...
  void onThemeChanged(bool value, ThemeProvider themeProvider) async {
    (value) ? themeProvider.setTheme(light) : themeProvider.setTheme(dark);
  ...
  void _logOut(BuildContext context, ThemeProvider themeNotifier) async {
